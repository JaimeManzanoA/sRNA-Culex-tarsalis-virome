...
make -f ../Makefile stats_virus2 SRR=Culex_Bunya_like_virus
make -f ../Makefile stats_virus2 SRR=Culex_Bunyavirus_2
make -f ../Makefile stats_virus2 SRR=Culex_Iflavi-like_virus_1
...
make -f ../Makefile stats_virus2 SRR=Tombusviridae
make -f ../Makefile stats_virus2 SRR=Marma_virus
make -f ../Makefile stats_virus2 SRR=Narnaviridae_RdRP